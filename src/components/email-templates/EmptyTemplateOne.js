              ...
              <tbody>
                <tr>
                  <td style={{ verticalAlign: 'middle' }}>
                    <table cellPadding="0" cellSpacing="0" style={{ verticalAlign: '-webkit-baseline-middle' }}>
                      <tbody>
                        <tr>
                          <td style={{ textAlign: 'center' }}>
                            <img
                              width="160"
                              style={{ maxWidth: '160px', display: 'block', margin: '0 auto', padding: '0', height: 'auto' }}
                        ...
                        <tr>
                          <td style={{ textAlign: 'center' }}>
                            <table cellPadding="0" cellSpacing="0" style={{ verticalAlign: '-webkit-baseline-middle', display: 'inline-block', fontSize: 'medium', fontFamily: 'Arial' }}>
                              <tbody>
                  ...
                  <td width="1" className="border-right-theme" style={{ height: '100%', width: '1px', borderRight: '1px solid #6D7FE2' }}>
                    <div></div>
                  </td>
                  <td width="12">
                    <div></div>
                  </td>
                  <td style={{ padding: '0px', verticalAlign: 'middle', minWidth: '200px' }}>
                    <h3 className="first_last-name font_props" style={{ margin: '0px', color: '#000', fontSize: '16px', textAlign: 'center', fontWeight: 'bold' }}>
                      John Doe
                    </h3>
                    <p id="job_title" className="job_title font_props" style={{ margin: '0px', color: '#000', fontSize: '14px', lineHeight: '22px', textAlign: 'center' }}>
                      Job Title
                    </p>
...
export default EmptyTemplateOne
